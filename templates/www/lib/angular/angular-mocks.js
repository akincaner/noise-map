 ...
 *
 * This mock implementation can be used to respond with www or dynamic responses via the
...
function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
   ...
   *      ```
   *    – The respond method takes a set of www data to be returned or a function that can
 ...
 *    | function(function(method, url, data, headers, params)}
 *    ```
 *    – The respond method takes a set of www data to be returned or a function that can return
